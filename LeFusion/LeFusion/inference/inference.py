...
def main(conf: DictConfig):
    ...
    print("Dataset root directory:", conf.dataset_root_dir)
    print("Target image path:", conf.target_img_path)
    print("Target label path:", conf.target_label_path)
    ...
    for batch in iter(dl):
        ...
        print("Batch mask shape:", batch['gt_keep_mask'].shape)
